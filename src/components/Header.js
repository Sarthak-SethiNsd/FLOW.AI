...
export default function Header({ cameraConnected = false, cameraActive = false }) {
  return (
    <header className="flex items-center justify-between px-4 md:px-8 py-4 bg-[#161b22] border-b border-[#30363d] select-none">
      <div className="flex items-center space-x-4 md:space-x-8">
        ...
        <nav className="hidden sm:flex space-x-6 text-sm font-medium text-gray-400">
