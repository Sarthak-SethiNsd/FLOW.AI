...
export default function PoseSelectorDropdown({ asanas = [] }) {
  ...
  return (
    <div className="bg-[#161b22] border border-[#30363d] rounded-xl p-4 flex flex-col space-y-2">
      <label className="text-xs uppercase tracking-widest text-gray-400 font-semibold">Quick Select Pose</label>
      <select 
        ...
        defaultValue=""
      >
        <option value="" disabled>Choose an asana to begin...</option>
        {asanas.map((asana) => (
